...
export const MONTHLY_BREAKDOWN = [
  { month: 'Nov-24', stCapGain: 0.1201, ordinaryIncome: -0.108 },
  { month: 'Dec-24', stCapGain: 0.1269, ordinaryIncome: -0.125 },
...
export const ANNUAL_BREAKDOWN = [
  ...
  { year: '2021', stCapGain: 1.513, ordinaryIncome: -1.3131 },
  { year: '2022', stCapGain: 1.486, ordinaryIncome: -1.347 },
...
export const HIST_ORD_LOSS_AVG =
  HIST_ORD_LOSS_RATES.reduce((a, b) => a + b, 0) / HIST_ORD_LOSS_RATES.length;
