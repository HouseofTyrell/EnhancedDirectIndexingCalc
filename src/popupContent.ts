...
export const POPUP_CONTENT: Record<string, PopupContent> = {
  ...
  'col-wa-income-tax': {
    ...
    definition:
      'Washington income tax remaining after the enacted $1 million standard deduction, strategy deductions, and the credit for Washington capital-gains excise already paid. Modeled beginning in projection year 3 (tax year 2028).',
    formula: 'max(0, WA Base Income − $1,000,000) × 9.9% − WA Capital-Gains Tax Credit',
    impact:
      'This enacted-law implementation is provisional pending final Washington DOR regulations and forms.',
  },
  'col-wa-cgt-credit': {
    title: 'Washington Capital-Gains Tax Credit',
    definition:
      'Credit against Washington’s 2028+ income tax for Washington capital-gains excise paid on overlapping income.',
    formula: 'min(WA Income Tax Before Credit, WA Capital-Gains Excise Paid)',
    impact:
      'Prevents the model from charging both the new 9.9% income tax and the capital-gains excise on the same dollars.',
  },
  ...
  'col-income-required': {
    title: 'Ordinary Income Needed to Use Available Deduction Capacity',
    definition:
    ...
    impact:
      'A planning threshold for comparing bonuses, option exercises, or Roth conversions — not ' +
      'recommended income and not necessarily eliminated dollar-for-dollar in every jurisdiction. ' +
      'Income below it can leave NOL available for later years.',
  },
